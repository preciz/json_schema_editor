...
/>)
      ...
      :redo ->
        ~H(<path d="M7.5 5a.75.75 0 0 1 1.28-.53l5 5a.75.75 0 0 1 0 1.06l-5 5a.75.75 0 0 1-1.28-.53V11.5H5.25A5.25 5.25 0 0 0 0 16.75v1a.75.75 0 0 1-1.5 0v-1a3.75 3.75 0 0 1 3.75-3.75h2.25V5Z" />)
    end
  end
